...
% PARRECOrganize
%
% Modified version for MWPI to deal with weird slice orders.
% 
...
% 
% Syntax:	[b,cPathRaw,cPathOut] = PercIm.Preprocess.PARRECOrganize(strDirRaw,<options>)
% 
% In:
...
%convert!
	b	= PercIm.Preprocess.PARREC2NIfTI(cPathRawAll(bConvertAll),cPathOutAll(bConvertAll),'b0first',opt.b0first,'cores',opt.cores,'silent',opt.silent);
