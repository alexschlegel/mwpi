...
%preprocess the fMRI data
	...
	%preprocess the functional data
        ...
        cPathFunctionalOld = cPathFunctional(~ifo.bNewFmri);
        cPathStructuralOld = cPathStructural(~ifo.bNewFmri);        
		[cPathFunctionalOld,cPathStructuralOld]	= varfun(@cellnestflatten,cPathFunctionalOld,cPathStructuralOld);
        
        % old scanner: slice_time_correct = 6
		FSLFEATPreprocess(cPathFunctionalOld,cPathStructuralOld,...
                            'motion_correct'		, true			, ...
        ...
        cPathFunctionalNew = cPathFunctional(ifo.bNewFmri);
        cPathStructuralNew = cPathStructural(ifo.bNewFmri);        
		[cPathFunctionalNew,cPathStructuralNew]	= varfun(@cellnestflatten,cPathFunctionalNew,cPathStructuralNew);
        
                        
        % new scanner: slice_time_correct = 7
		FSLFEATPreprocess(cPathFunctionalNew,cPathStructuralNew,...
                            'motion_correct'		, true			, ...
                            'slice_time_correct'	, 7				, ...
                            'spatial_fwhm'			, 6				, ...
                            'norm_intensity'		, false			, ...
                            'highpass'				, 100			, ...
                            'lowpass'				, false			, ...
...
%concatenate the fMRI runs
	...
	FSLConcatenate(cPathFunctionalPP,...
                    'cores'	, opt.cores	, ...
                    'force'	, opt.force	  ...
                    );
