...
switch opt.map(shp)
	case 1 %R1
		[im,b]	= MWPI.Stim.Rect(1,opt.rotation,opt.flip);
	case 2 %R2
		[im,b]	= MWPI.Stim.Rect(2,opt.rotation,opt.flip);
	case 3 %P1
		[im,b]	= MWPI.Stim.Polar(1,opt.rotation,opt.flip);
	case 4 %P2
		[im,b]	= MWPI.Stim.Polar(2,opt.rotation,opt.flip);
	otherwise
		error('wtf?');
end
